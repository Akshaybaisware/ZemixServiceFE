...
const StampPaperView = () => {
  ...
  const storePDFToCloudinary = async (photoPreview, signaturePreview) => {
    ...
    html2canvas(capture).then(async (canvas) => {
      ...
      const pdfUpload = await cloudinary.uploader.upload(pdf.output("blob"), {
        resource_type: "raw",
        folder: "pdfs", // Optional: Change the folder name as per your preference
      });

      console.log("PDF uploaded to Cloudinary:", pdfUpload);
      setLoader(false);
    });
  };
        ...
        <Box ref={targetRef} m={["1rem", "7rem"]} className="downLodeBox">
          ...
          <Box>
            <Text>
              ...
              website provided by Tricom Enterprise at the time of signup. You
              ...
              price 38 RS (INR) per form (if you achieved cut-off above 486) The
          ...
          <Box>
            ...
            <Text>
              ...
              <br />
              <br /> Registration Amount : 5700 (Per Month Basis) INR. Reg.
